...
public class BilibiliTest {
     ...
     * avatar：评论者的头像地址
     * is_contractor：是不是up的老粉
     * contract_desc：老粉牌子的称呼
     ...
     * fans_level：评论者的粉丝牌等级(注意：有些用户可能没有带粉丝牌，返回为空)
     * fans_name：评论者的粉丝牌内容（名字）(注意：有些用户可能没有带粉丝牌，返回为空)
     * thisUserMessage：评论者的论点（即评论内容）
     * pictures：评论的图片列表
     * messageEmote：评论的渲染信息
    ...
    // 视频的id
    public static final String Oid = "312121479";

    // 视频的bvid
    public static final String BVid = "BV1MN411P7qq";


    /**
     * 请注意，代码中使用的oid含义是视频的aid或者avid
     */

    public static void main(String[] args) throws IOException {
        long statrTime = System.currentTimeMillis();
//        List<Map<String, Object>> resultList = getCommentsByOidAndTime("898762590", 50, "2022-08-01 00:00:00", "2022-04-07 00:00:00");
//        List<Map<String, Object>> resultList = getCommentsByOidAndTime("312121479", 100, "2023-04-04 18:15:37", "2023-04-05 00:00:00");
        List<Map<String, Object>> resultList = getCommentsByOidAndTime(Oid, 2500, "2022-04-08 00:00:00", "2023-04-14 00:00:00");
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        System.out.println(resultList.size());
        System.out.println("===================================================================================================================================");
//        for (Map<String, Object> map : resultList) {
//            long time = Long.parseLong(String.valueOf(map.get("ctime")));
//            System.out.println("用户名：" + map.get("uname"));
//            System.out.println("uid：" + map.get("userid"));
//            System.out.println("评论者性别：" + map.get("sex"));
//            System.out.println("评论者b站等级：" + map.get("userLevel"));
//            System.out.println("评论内容：" + map.get("thisUserMessage"));
//            System.out.println("评论时间：" + simpleDateFormat.format(time*1000));
//            System.out.println("点赞数：" + map.get("like"));
//            System.out.println("该评论回复数量：" + map.get("rcount"));
//            System.out.println("up主是否点赞：" + map.get("isUpLikeThisMessage"));
//            System.out.println("up主是否回复：" + map.get("isUpReplyThisMessage"));
//            System.out.println("是不是up的老粉：" + map.get("is_contractor"));
//            System.out.println("老粉牌子的称呼：" + map.get("contract_desc"));
//            System.out.println("评论者的会员类型：" + map.get("vipType"));
//            System.out.println("评论者现在是不是会员：" + map.get("vipStatus"));
//            System.out.println("粉丝牌子名字：" + map.get("fans_name"));
//            System.out.println("粉丝牌子等级：" + map.get("fans_level"));
//            System.out.println("=====================================================================================================================================================================================================================");
        ...
        switch (resultJsonMap.get("code").toString()) {
            case "0":
                ...
                for (Map<String, Object> replie : replies) {
                    ...
                    // 记录是不是老粉
                    map.put("is_contractor", memberJsonMap.get("is_contractor"));
                    // 记录老粉牌子称呼
                    map.put("contract_desc", memberJsonMap.get("contract_desc"));
                    // 记录会员信息（type=0 非会员， type=1 大会员， type=2 年度大会员），需要注意的是4月1日可能会不同，但是我没办法测试了
                    ...
                    if (memberJsonMap.get("fans_detail") != null) {
                        ...
                        // 记录粉丝牌的等级
                        map.put("fans_level", fansDetailJsonMap.get("level"));
                        // 记录粉丝牌的名字
                        map.put("fans_name", fansDetailJsonMap.get("medal_name"));
                    } else {
                        map.put("fans_detail", null);
                        // 记录粉丝牌的等级
                        map.put("fans_level", "0");
                        // 记录粉丝牌的名字
                        map.put("fans_name", "");
                    }
                    // 记录评论的信息
...
//    }
//
//    public static void postMain(String[] args) {
//        try {
//            Map<String, String> params = new HashMap<String, String>();
//            params.put("type", "1");
//            params.put("old", "7782189");
